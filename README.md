...
The project started as a part of an interview process with the company named [DigiSay](https://digisay.breezy.hr/), I received an email with the following task:
